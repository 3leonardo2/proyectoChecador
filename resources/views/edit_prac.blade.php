            ...
            <div class="practicante-scrollable-content">
                ...
                <div class="form-group">
                    ...
                    <select id="sexo" name="sexo">
                        ...
                        <option value="Hombre" {{ old('sexo', $practicante->sexo) == 'Hombre' ? 'selected' : '' }}>
                            Hombre</option>
                        <option value="Mujer" {{ old('sexo', $practicante->sexo) == 'Mujer' ? 'selected' : '' }}>Mujer
                        </option>
                        <option value="Otro" {{ old('sexo', $practicante->sexo) == 'Otro' ? 'selected' : '' }}>Otro
                        </option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group carrera-select-container">
                    ...
                    <select name="carrera_id" id="carrera_id" class="form-control"
                        {{ $practicante->institucion_id ? '' : 'disabled' }}>
                    ...
                    <div class="no-carreras-message" style="display: none; color: #dc3545;">No hay carreras
                        disponibles para esta institución.</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="area_asignada" name="area_asignada">
                        ...
                        <option value="Contraloria"
                            {{ $practicante->area_asignada == 'Contraloria' ? 'selected' : '' }}>Contraloria</option>
                        <option value="Ventas" {{ $practicante->area_asignada == 'Ventas' ? 'selected' : '' }}>Ventas
                        </option>
                        <option value="Sistemas" {{ $practicante->area_asignada == 'Sistemas' ? 'selected' : '' }}>
                            Sistemas</option>
                        <option value="AyB" {{ $practicante->area_asignada == 'AyB' ? 'selected' : '' }}>AyB
                        </option>
                        <option value="Mantenimiento"
                            {{ $practicante->area_asignada == 'Mantenimiento' ? 'selected' : '' }}>Mantenimiento
                        </option>
                        <option value="Recursos Humanos"
                            {{ $practicante->area_asignada == 'Recursos Humanos' ? 'selected' : '' }}>Recursos Humanos
                        </option>
                        <option value="Dirección" {{ $practicante->area_asignada == 'Dirección' ? 'selected' : '' }}>
                            Dirección</option>
                        <option value="Recepción" {{ $practicante->area_asignada == 'Recepción' ? 'selected' : '' }}>
                            Recepción</option>
                        <option value="Reservaciones"
                            {{ $practicante->area_asignada == 'Reservaciones' ? 'selected' : '' }}>Reservaciones
                        </option>
                        <option value="Cocina" {{ $practicante->area_asignada == 'Cocina' ? 'selected' : '' }}>Cocina
                        </option>
                        <option value="Ama de llaves"
                            {{ $practicante->area_asignada == 'Ama de llaves' ? 'selected' : '' }}>Ama de llaves
                        </option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="acceso_comedor" value="0">
                    <input type="checkbox" id="acceso_comedor" name="acceso_comedor" value="1"
                        {{ old('acceso_comedor', $practicante->acceso_comedor) ? 'checked' : '' }}>
                </div>
